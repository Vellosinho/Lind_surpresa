        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              child: SizedBox(height: 64, width: (controller.playerLife > 0 ) ?(controller.playerLife * 3.52) : 0, child: DecoratedBox(decoration: BoxDecoration(color: Color(0xffff0000))))),
